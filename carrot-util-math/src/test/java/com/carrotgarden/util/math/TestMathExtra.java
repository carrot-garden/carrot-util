 ...
 */
package com.carrotgarden.util.math;
...
public class TestMathExtra {
	...
	public void testMantissa0() {
		...
		final DoubleParts parts = MathExtra.extractDecimal(v1);
	...
	static void testExtract(final long wholeRange, final long fractRange,
		...
		for (int index = 0; index < count; index++) {
			...
			final DoubleParts parts = MathExtra.extractDecimal(decimal.value);
