...
import com.carrotgarden.util.values.provider.DefTextByteArray;
import com.carrotgarden.util.values.provider.DefTextLong;
import com.carrotgarden.util.values.provider.DefTextString;
